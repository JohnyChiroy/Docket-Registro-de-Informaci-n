...
namespace machupichu {
	...
	public ref class ingresar : public System::Windows::Forms::Form
	{
		...
		void contador() {//Es el contador de nuestras ordenes
			contOrden = contOrden + 1;
			lbl_orden->Text = Convert::ToString(contOrden);
		}
	public:
		ingresar(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(654, 68);
			...
			this->label22->Location = System::Drawing::Point(325, 68);
			...
			this->label21->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label21->Location = System::Drawing::Point(745, 39);
			...
			this->btn_guardar->Location = System::Drawing::Point(765, 68);
			this->btn_guardar->Name = L"btn_guardar";
			this->btn_guardar->Size = System::Drawing::Size(83, 30);
			...
			this->txt_tectel->Location = System::Drawing::Point(203, 68);
			...
			this->txt_tecnico->Location = System::Drawing::Point(203, 39);
			this->txt_tecnico->Name = L"txt_tecnico";
			this->txt_tecnico->Size = System::Drawing::Size(540, 20);
			...
			this->label14->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label14->Location = System::Drawing::Point(118, 72);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"MV Boli", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(12, 3);
			...
			this->label13->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label13->Location = System::Drawing::Point(118, 39);
			...
			// lbl_orden
			// 
			this->lbl_orden->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->lbl_orden->AutoSize = true;
			this->lbl_orden->BackColor = System::Drawing::Color::Lime;
			this->lbl_orden->Location = System::Drawing::Point(477, 11);
			this->lbl_orden->Name = L"lbl_orden";
			this->lbl_orden->Size = System::Drawing::Size(0, 13);
			this->lbl_orden->TabIndex = 10;
			// 
			// label23
			// 
			...
			this->label23->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label23->Location = System::Drawing::Point(381, 9);
			...
			this->label16->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label16->Location = System::Drawing::Point(749, 33);
			...
			this->label15->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label15->Location = System::Drawing::Point(327, 100);
			...
			this->txt_telefono->Location = System::Drawing::Point(203, 96);
			...
			this->txt_direccion->Location = System::Drawing::Point(203, 66);
			...
			this->txt_nombre->Location = System::Drawing::Point(203, 33);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(118, 100);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(118, 66);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(118, 33);
			...
			this->label20->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label20->Location = System::Drawing::Point(827, 29);
			...
			this->label19->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label19->Location = System::Drawing::Point(582, 33);
			...
			this->label18->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label18->Location = System::Drawing::Point(347, 34);
			...
			this->label17->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label17->Location = System::Drawing::Point(171, 34);
			...
			this->txt_estado->Location = System::Drawing::Point(474, 92);
			...
			this->txt_accesorios->Location = System::Drawing::Point(56, 92);
			...
			this->txt_serie->Location = System::Drawing::Point(674, 33);
			...
			this->txt_modelo->Location = System::Drawing::Point(428, 32);
			...
			this->txt_marca->Location = System::Drawing::Point(247, 33);
			...
			this->txt_tipo->Location = System::Drawing::Point(71, 33);
			...
			this->label12->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label12->Location = System::Drawing::Point(53, 73);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label11->Location = System::Drawing::Point(471, 73);
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label10->Location = System::Drawing::Point(598, 33);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(362, 34);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(190, 34);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(24, 34);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"MV Boli", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(12, 3);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txt_nombre->Text == "" || txt_telefono->Text == "" || txt_tipo->Text == "" || txt_marca->Text == "" || txt_modelo->Text == ""
		...
		//archivo->Write("A");
		this->txt_nombre->Text = L""; this->txt_direccion->Text = ""; this->txt_telefono->Text = "";
	...
	/*if (txt_nombre->Text == "") {
		...
		MessageBox::Show("El TELEFONO es obligatorio", "ERROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}else if (txt_tipo->Text == ""){
		MessageBox::Show("El TIPO de equipo es obligatorio", "ERROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
		...
		MessageBox::Show("La SERIE es obligatoria", "ERROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}else if (txt_tecnico->Text == "") {
		MessageBox::Show("El nombre del TECNICO es obligatorio", "ERROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}else if (txt_tectel->Text == "") {
		MessageBox::Show("El teléfono del TECNICO es obligatorio", "ERROR", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}else {
		datos->Write("\r\n");
		...
		datos->Write("A");
		this->textBox1->Text = L""; this->textBox2->Text = ""; this->textBox3->Text = "";
		MessageBox::Show("HAZ INGRESADO CORRECTAMENTE....", "DATOS ALUMNO", MessageBoxButtons::OK, MessageBoxIcon::Information);
	}*/
	archivo->Close();
}
